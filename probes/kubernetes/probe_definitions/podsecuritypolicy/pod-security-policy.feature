...
@csp/aws
@csp/gcp
#@csp/openshift TODO: OpenShift uses SecurityContextConstraints so the implementation of the "Given" clauses will fail
@standard/cis/5.2
Feature: Maximise security through Pod Security Policies

As a Cloud Security Auditor
...
# think we should do that, but is that a separate scenario or blend into this one?  for some this makes sense - mark with @detective?
	...
	@control/type/preventative @standard/cis/5.2.1
	...
	@control/type/preventative @standard/cis/5.2.2
	...
	@control/type/preventative @standard/cis/5.2.3
	...
	@control/type/preventative @standard/cis/5.2.4
	...
	@control/type/preventative @standard/cis/5.2.5
	...
	@control/type/preventative @standard/cis/5.2.6
